<?php
require 'config.php';
// Орел. ЯД.ВК.Робот+КЦ.Лидмаркет — ЯД+ВК — 11.02.2026 10:22
...
$hookName = 'orel_yad_vk_robot_kts_lidmarket';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. ЯД.ВК.Робот+КЦ.Лидмаркет\n";
    $securityLog .= "Hook: orel_yad_vk_robot_kts_lidmarket\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_yad_vk_robot_kts_lidmarket.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_yad_vk_robot_kts_lidmarket_failed.json';
