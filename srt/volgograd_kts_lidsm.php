<?php
require 'config.php';
// Волгоград.КЦ.ЛидсМ — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Волгоград.КЦ.ЛидсМ\n";
    $securityLog .= "Hook: volgograd_kts_lidsm\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/volgograd_kts_lidsm.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/volgograd_kts_lidsm_failed.json';
