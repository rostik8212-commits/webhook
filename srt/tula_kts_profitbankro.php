<?php
require 'config.php';
// Тула. КЦ. ПрофитБанкро — КЦ — 11.02.2026 17:05
...
$hookName = 'tula_kts_profitbankro';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. КЦ. ПрофитБанкро\n";
    $securityLog .= "Hook: tula_kts_profitbankro\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_kts_profitbankro.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_kts_profitbankro_failed.json';
