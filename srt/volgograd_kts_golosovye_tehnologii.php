<?php
require 'config.php';
// Волгоград.КЦ.Голосовые Технологии — КЦ — 24.02.2026 14:58
...
$hookName = 'volgograd_kts_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Волгоград.КЦ.Голосовые Технологии\n";
    $securityLog .= "Hook: volgograd_kts_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/volgograd_kts_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/volgograd_kts_golosovye_tehnologii_failed.json';
