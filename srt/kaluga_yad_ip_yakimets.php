<?php
require 'config.php';
// Калуга. ЯД. ИП Якимец — Tilda — 11.02.2026 10:22
...
$hookName = 'kaluga_yad_ip_yakimets';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. ЯД. ИП Якимец\n";
    $securityLog .= "Hook: kaluga_yad_ip_yakimets\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_ip_yakimets.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_ip_yakimets_failed.json';
