<?php
require 'config.php';
// Брянск. Маркетикс — КЦ — 19.02.2026 23:50
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. Маркетикс\n";
    $securityLog .= "Hook: bryansk_marketiks\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_marketiks.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_marketiks_failed.json';
