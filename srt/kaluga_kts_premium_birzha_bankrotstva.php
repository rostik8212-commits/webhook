<?php
require 'config.php';
// Калуга.КЦ премиум.Биржа Банкротства — КЦ — 26.02.2026 10:54
...
$hookName = 'kaluga_kts_premium_birzha_bankrotstva';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.КЦ премиум.Биржа Банкротства\n";
    $securityLog .= "Hook: kaluga_kts_premium_birzha_bankrotstva\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_premium_birzha_bankrotstva.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_premium_birzha_bankrotstva_failed.json';
