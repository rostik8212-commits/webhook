<?php
require 'config.php';
// Липецк. КЦ.Плотников — КЦ — 20.02.2026 00:42
...
$hookName = 'lipetsk_kts_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. КЦ.Плотников\n";
    $securityLog .= "Hook: lipetsk_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_kts_plotnikov_failed.json';
