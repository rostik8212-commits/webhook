<?php
require 'config.php';
// КТЛО. ЯД. Милена — Tilda — 24.02.2026 23:20
...
$cityFieldName = 'Регион_проживания';

// Маппинг названий полей для комментариев
$fieldLabels = [
    'summa' => 'сумма долга',
    'gorod' => 'Город',
    'Регион_проживания' => 'Город',
];
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: КТЛО. ЯД. Милена\n";
    $securityLog .= "Hook: ktlo_yad_milena\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ktlo_yad_milena.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ktlo_yad_milena_failed.json';
