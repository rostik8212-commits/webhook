<?php
require 'config.php';
// Дистант. ЯД+Робот. Make it Deal — ЯД+Робот — 11.02.2026 10:22
...
$hookName = 'distant_yad_robot_make_it_deal';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Дистант. ЯД+Робот. Make it Deal\n";
    $securityLog .= "Hook: distant_yad_robot_make_it_deal\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/distant_yad_robot_make_it_deal.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/distant_yad_robot_make_it_deal_failed.json';
