<?php
require 'config.php';
// Калуга.МайФорсе.Новый — КЦ — 11.02.2026 10:22
...
$hookName = 'kaluga_mayforse_novyy';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.МайФорсе.Новый\n";
    $securityLog .= "Hook: kaluga_mayforse_novyy\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_mayforse_novyy.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_mayforse_novyy_failed.json';
