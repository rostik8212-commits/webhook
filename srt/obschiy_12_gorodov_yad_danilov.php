<?php
require 'config.php';
// Общий 12 городов ЯД. Данилов — Директ — 26.02.2026 15:10
...
$hookName = 'obschiy_12_gorodov_yad_danilov';
...
$cityMapping = [
    ...
    'Владимирская область' => '5051',
    'владимирская обл' => '5051',
    'владимирская обл.' => '5051',
    'иваново' => '982203',
    'ИВАНОВО' => '982203',
    'Иваново' => '982203',
    'ивановская область' => '982203',
    'Ивановская область' => '982203',
    'ивановская обл' => '982203',
    'ивановская обл.' => '982203',
    'калуга' => '5',
    'КАЛУГА' => '5',
    'Калуга' => '5',
    ...
    'ОРЕЛ' => '1126563',
    'Орел' => '1126563',
    'орловская область' => '1126563',
    'Орловская область' => '1126563',
    'орловская обл' => '1126563',
    'орловская обл.' => '1126563',
    'пенза' => '3',
    'ПЕНЗА' => '3',
    ...
    'ульяновск' => '1195433',
    'УЛЬЯНОВСК' => '1195433',
    'ульяновская область' => '1195433',
    'ульяновская обл' => '1195433',
    'ульяновская обл.' => '1195433',
    'тула' => '29407',
    'ТУЛА' => '29407',
    'Тула' => '29407',
    'тульская область' => '29407',
    'Тульская область' => '29407',
    'тульская обл' => '29407',
    'тульская обл.' => '29407',
    'ярославль' => '332377',
    'ЯРОСЛАВЛЬ' => '332377',
    'ярославская область' => '332377',
    'ярославская обл' => '332377',
    'ярославская обл.' => '332377',
    'ростов-на-дону' => '39209',
    'РОСТОВ-НА-ДОНУ' => '39209',
    'ростов на дону' => '39209',
    'ростов' => '39209',
    'ростовская область' => '39209',
    'ростовская обл' => '39209',
    'ростовская обл.' => '39209',
    'саранск' => '376495',
    'САРАНСК' => '376495',
    'Саранск' => '376495',
    'республика мордовия' => '376495',
    'Республика Мордовия' => '376495',
    'респ. мордовия' => '376495',
    'Респ. Мордовия' => '376495',
    'мордовия' => '376495',
    'Мордовия' => '376495',
    'МОРДОВИЯ' => '376495',
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Общий 12 городов ЯД. Данилов\n";
    $securityLog .= "Hook: obschiy_12_gorodov_yad_danilov\n";
...
if (isset($_REQUEST['test']) || (isset($_REQUEST['action']) && $_REQUEST['action'] === 'test')) {
    ...
    file_put_contents(__DIR__ . '/../logs/obschiy_12_gorodov_yad_danilov.log', date('d.m.Y H:i:s') . " " . $logMsg, FILE_APPEND);
    header('Content-Type: application/json; charset=utf-8');
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/obschiy_12_gorodov_yad_danilov.log', $logEntry, FILE_APPEND);
...
// Поле utm_term -> UTM_TERM
$v = $_POST['utm_term'] ?? '';
if (is_array($v) && isset($v['value'])) $v = $v['value'];
if (is_array($v)) $v = reset($v) ?: '';
if (is_scalar($v) && trim((string)$v) !== '') $fields['UTM_TERM'] = trim((string)$v);
// Поле utm_content -> UTM_CONTENT
$v = $_POST['utm_content'] ?? '';
if (is_array($v) && isset($v['value'])) $v = $v['value'];
if (is_array($v)) $v = reset($v) ?: '';
if (is_scalar($v) && trim((string)$v) !== '') $fields['UTM_CONTENT'] = trim((string)$v);
// Кастомное поле города UF_CRM_GOROD (из $input['city'] с маппингом)
if (!empty($cityId)) {
    $fields['UF_CRM_GOROD'] = $cityId;
} elseif (!empty($input['city'])) {
    $fields['UF_CRM_GOROD'] = $input['city'];
}
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/obschiy_12_gorodov_yad_danilov_failed.json';
