<?php
require 'config.php';
// Тула. Робот+КЦ. Биржа банкротства — КЦ — 11.02.2026 10:22
...
$hookName = 'tula_robot_kts_birzha_bankrotstva';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. Робот+КЦ. Биржа банкротства\n";
    $securityLog .= "Hook: tula_robot_kts_birzha_bankrotstva\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_robot_kts_birzha_bankrotstva.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_robot_kts_birzha_bankrotstva_failed.json';
