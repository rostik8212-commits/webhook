<?php
require 'config.php';
// Орел-ВДС-flexbe — Flexbe — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел-ВДС-flexbe\n";
    $securityLog .= "Hook: orel-vds-flexbe\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel-vds-flexbe.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel-vds-flexbe_failed.json';
