<?php
require 'config.php';
// Ярославль. КЦ INDI GROUP 2 — КЦ — 18.02.2026 12:29
...
$hookName = 'yaroslavl_kts_indi_group_2';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. КЦ INDI GROUP 2\n";
    $securityLog .= "Hook: yaroslavl_kts_indi_group_2\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_kts_indi_group_2.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_kts_indi_group_2_failed.json';
