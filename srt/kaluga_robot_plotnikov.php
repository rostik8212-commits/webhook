<?php
require 'config.php';
// Калуга. Робот. Плотников — Робот — 20.02.2026 00:31
...
$hookName = 'kaluga_robot_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. Робот. Плотников\n";
    $securityLog .= "Hook: kaluga_robot_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_robot_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_robot_plotnikov_failed.json';
