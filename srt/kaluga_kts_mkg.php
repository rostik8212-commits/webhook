<?php
require 'config.php';
// Калуга. КЦ. МКГ — КЦ — 11.02.2026 14:10
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. КЦ. МКГ\n";
    $securityLog .= "Hook: kaluga_kts_mkg\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_mkg.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_mkg_failed.json';
