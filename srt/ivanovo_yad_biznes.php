<?php
require 'config.php';
// Иваново. ЯД. Бизнес — Tilda — 26.02.2026 10:15
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Иваново. ЯД. Бизнес\n";
    $securityLog .= "Hook: ivanovo_yad_biznes\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ivanovo_yad_biznes.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ivanovo_yad_biznes_failed.json';
