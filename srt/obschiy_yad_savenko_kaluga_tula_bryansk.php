<?php
require 'config.php';
// Общий. ЯД. Савенко. Калуга Тула Брянск — Директ — 13.02.2026 11:59
...
$hookName = 'obschiy_yad_savenko_kaluga_tula_bryansk';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Общий. ЯД. Савенко. Калуга Тула Брянск\n";
    $securityLog .= "Hook: obschiy_yad_savenko_kaluga_tula_bryansk\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/obschiy_yad_savenko_kaluga_tula_bryansk.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/obschiy_yad_savenko_kaluga_tula_bryansk_failed.json';
