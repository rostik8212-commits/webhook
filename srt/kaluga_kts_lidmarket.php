<?php
require 'config.php';
// Калуга. КЦ. Лидмаркет — ЯД+ВК — 11.02.2026 15:03
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. КЦ. Лидмаркет\n";
    $securityLog .= "Hook: kaluga_kts_lidmarket\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_lidmarket.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_lidmarket_failed.json';
