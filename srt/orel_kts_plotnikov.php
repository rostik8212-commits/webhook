<?php
require 'config.php';
// Орел. КЦ.Плотников — КЦ — 20.02.2026 00:44
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. КЦ.Плотников\n";
    $securityLog .= "Hook: orel_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_kts_plotnikov_failed.json';
