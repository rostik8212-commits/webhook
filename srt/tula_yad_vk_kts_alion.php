<?php
require 'config.php';
// Тула. ЯД, ВК + КЦ Алион — ЯД+ВК+КЦ — 19.02.2026 23:59
...
$hookName = 'tula_yad_vk_kts_alion';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. ЯД, ВК + КЦ Алион\n";
    $securityLog .= "Hook: tula_yad_vk_kts_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_vk_kts_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_vk_kts_alion_failed.json';
