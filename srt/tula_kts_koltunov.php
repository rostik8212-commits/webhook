<?php
require 'config.php';
// Тула. КЦ Колтунов — КЦ — 20.02.2026 13:51
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. КЦ Колтунов\n";
    $securityLog .= "Hook: tula_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_kts_koltunov_failed.json';
