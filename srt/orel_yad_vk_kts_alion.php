<?php
require 'config.php';
// Орел. ЯД, ВК + КЦ Алион — ЯД+ВК+КЦ — 19.02.2026 23:59
...
$hookName = 'orel_yad_vk_kts_alion';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. ЯД, ВК + КЦ Алион\n";
    $securityLog .= "Hook: orel_yad_vk_kts_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_yad_vk_kts_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_yad_vk_kts_alion_failed.json';
