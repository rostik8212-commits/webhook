<?php
require 'config.php';
// Тула. Робот. Плотников — Робот — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. Робот. Плотников\n";
    $securityLog .= "Hook: tula_robot_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_robot_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_robot_plotnikov_failed.json';
