<?php
require 'config.php';
// Брянск. База. Робот. Сафонов — Zvonok.com — 11.02.2026 10:22
...
// SOURCE_ID: 1088
// Отправка комментариев в Bitrix: НЕТ (только логи)
// Авто-UTM: НЕТ
...
$hookName = 'bryansk_baza_robot_safonov';

// Флаг отправки комментариев в Bitrix (зависит от маппинга)
$sendCommentsToBitrix = false;
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. База. Робот. Сафонов\n";
    $securityLog .= "Hook: bryansk_baza_robot_safonov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_baza_robot_safonov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_baza_robot_safonov_failed.json';
