<?php
require 'config.php';
// Брянск. Базы. Свой робот — Робот+базы — 11.02.2026 16:01
...
$hookName = 'bryansk_bazy_svoy_robot';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. Базы. Свой робот\n";
    $securityLog .= "Hook: bryansk_bazy_svoy_robot\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_bazy_svoy_robot.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_bazy_svoy_robot_failed.json';
