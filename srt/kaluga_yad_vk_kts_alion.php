<?php
require 'config.php';
// Калуга. ЯД, ВК + КЦ Алион — ЯД+ВК+КЦ — 19.02.2026 23:57
...
$hookName = 'kaluga_yad_vk_kts_alion';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. ЯД, ВК + КЦ Алион\n";
    $securityLog .= "Hook: kaluga_yad_vk_kts_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_vk_kts_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_vk_kts_alion_failed.json';
