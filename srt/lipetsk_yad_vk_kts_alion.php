<?php
require 'config.php';
// Липецк. ЯД, ВК + КЦ Алион — ЯД+ВК+КЦ — 19.02.2026 23:56
...
$hookName = 'lipetsk_yad_vk_kts_alion';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. ЯД, ВК + КЦ Алион\n";
    $securityLog .= "Hook: lipetsk_yad_vk_kts_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_yad_vk_kts_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_yad_vk_kts_alion_failed.json';
