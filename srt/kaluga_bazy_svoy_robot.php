<?php
require 'config.php';
// Калуга. Базы. Свой робот — Робот+базы — 11.02.2026 13:05
...
$hookName = 'kaluga_bazy_svoy_robot';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. Базы. Свой робот\n";
    $securityLog .= "Hook: kaluga_bazy_svoy_robot\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_bazy_svoy_robot.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_bazy_svoy_robot_failed.json';
