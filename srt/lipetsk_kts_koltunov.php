<?php
require 'config.php';
// Липецк. КЦ.Колтунов — КЦ — 20.02.2026 13:50
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. КЦ.Колтунов\n";
    $securityLog .= "Hook: lipetsk_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_kts_koltunov_failed.json';
