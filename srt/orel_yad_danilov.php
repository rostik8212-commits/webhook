<?php
require 'config.php';
// Орел. ЯД. Данилов — Tilda — 26.02.2026 12:41
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. ЯД. Данилов\n";
    $securityLog .= "Hook: orel_yad_danilov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_yad_danilov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_yad_danilov_failed.json';
