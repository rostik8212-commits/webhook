<?php
require 'config.php';
// Нижний Новгород. КЦ L- BFL — КЦ — 11.02.2026 10:22
...
$hookName = 'nizhniy_novgorod_kts_l-_bfl';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Нижний Новгород. КЦ L- BFL\n";
    $securityLog .= "Hook: nizhniy_novgorod_kts_l-_bfl\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/nizhniy_novgorod_kts_l-_bfl.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/nizhniy_novgorod_kts_l-_bfl_failed.json';
