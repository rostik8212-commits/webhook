<?php
require 'config.php';
// Владимир. КЦ L- BFL — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Владимир. КЦ L- BFL\n";
    $securityLog .= "Hook: vladimir_kts_l-_bfl\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/vladimir_kts_l-_bfl.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/vladimir_kts_l-_bfl_failed.json';
