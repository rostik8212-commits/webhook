<?php
require 'config.php';
// Ярославль. КЦ L- BFL — Базы + КЦ — 23.02.2026 13:24
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. КЦ L- BFL\n";
    $securityLog .= "Hook: yaroslavl_kts_l-_bfl\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_kts_l-_bfl.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_kts_l-_bfl_failed.json';
