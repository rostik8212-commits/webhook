<?php
require 'config.php';
// Калуга.КЦ.Плотников — КЦ — 20.02.2026 00:33
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.КЦ.Плотников\n";
    $securityLog .= "Hook: kaluga_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_plotnikov_failed.json';
