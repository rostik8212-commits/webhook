<?php
require 'config.php';
// Тула. ЯД. ИП Якимец — Tilda — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. ЯД. ИП Якимец\n";
    $securityLog .= "Hook: tula_yad_ip_yakimets\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_ip_yakimets.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_ip_yakimets_failed.json';
