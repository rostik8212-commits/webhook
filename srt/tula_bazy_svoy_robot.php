<?php
require 'config.php';
// Тула. Базы. Свой робот — Робот+базы — 11.02.2026 16:02
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. Базы. Свой робот\n";
    $securityLog .= "Hook: tula_bazy_svoy_robot\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_bazy_svoy_robot.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_bazy_svoy_robot_failed.json';
