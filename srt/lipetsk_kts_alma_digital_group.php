<?php
require 'config.php';
// Липецк. КЦ. Alma Digital Group — КЦ — 24.02.2026 12:23
...
$hookName = 'lipetsk_kts_alma_digital_group';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. КЦ. Alma Digital Group\n";
    $securityLog .= "Hook: lipetsk_kts_alma_digital_group\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_kts_alma_digital_group.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_kts_alma_digital_group_failed.json';
