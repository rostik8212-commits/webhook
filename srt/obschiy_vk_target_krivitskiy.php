<?php
require 'config.php';
// Общий. ВК таргет. Кривицкий — ВК — 13.02.2026 15:52
...
$hookName = 'obschiy_vk_target_krivitskiy';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Общий. ВК таргет. Кривицкий\n";
    $securityLog .= "Hook: obschiy_vk_target_krivitskiy\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/obschiy_vk_target_krivitskiy.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/obschiy_vk_target_krivitskiy_failed.json';
