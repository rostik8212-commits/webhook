<?php
require 'config.php';
// Дистант. ЯД+ВК.КЦ.Колтунов — КЦ — 20.02.2026 13:46
...
$hookName = 'distant_yad_vk_kts_koltunov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Дистант. ЯД+ВК.КЦ.Колтунов\n";
    $securityLog .= "Hook: distant_yad_vk_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/distant_yad_vk_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/distant_yad_vk_kts_koltunov_failed.json';
