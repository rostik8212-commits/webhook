<?php
require 'config.php';
// Тула.ЯД.Бизнес — Tilda — 25.02.2026 18:53
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула.ЯД.Бизнес\n";
    $securityLog .= "Hook: tula_yad_biznes\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_biznes.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_biznes_failed.json';
