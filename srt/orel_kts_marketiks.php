<?php
require 'config.php';
// Орёл. КЦ.Маркетикс — КЦ — 20.02.2026 17:17
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орёл. КЦ.Маркетикс\n";
    $securityLog .= "Hook: orel_kts_marketiks\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_kts_marketiks.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_kts_marketiks_failed.json';
