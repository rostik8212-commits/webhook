<?php
require 'config.php';
// Орёл. ВК. Сергеев — ВК — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орёл. ВК. Сергеев\n";
    $securityLog .= "Hook: orel_vk_sergeev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_vk_sergeev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_vk_sergeev_failed.json';
