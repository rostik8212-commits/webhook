<?php
require 'config.php';
// КТБО ЯД Якимец — Tilda — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: КТБО ЯД Якимец\n";
    $securityLog .= "Hook: ktbo_yad_yakimets\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ktbo_yad_yakimets.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ktbo_yad_yakimets_failed.json';
