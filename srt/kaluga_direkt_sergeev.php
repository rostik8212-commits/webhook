<?php
require 'config.php';
// Калуга. Директ. Сергеев — Flexbe — 11.02.2026 10:22
...
$hookName = 'kaluga_direkt_sergeev';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. Директ. Сергеев\n";
    $securityLog .= "Hook: kaluga_direkt_sergeev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_direkt_sergeev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_direkt_sergeev_failed.json';
