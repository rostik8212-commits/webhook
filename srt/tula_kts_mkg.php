<?php
require 'config.php';
// Тула. КЦ. МКГ — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. КЦ. МКГ\n";
    $securityLog .= "Hook: tula_kts_mkg\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_kts_mkg.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_kts_mkg_failed.json';
