<?php
require 'config.php';
// Орел. КЦ ЛидсМ — КЦ — 20.02.2026 00:17
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. КЦ ЛидсМ\n";
    $securityLog .= "Hook: orel_kts_lidsm\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_kts_lidsm.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_kts_lidsm_failed.json';
