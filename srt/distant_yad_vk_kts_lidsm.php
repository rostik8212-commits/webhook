<?php
require 'config.php';
// Дистант. ЯД+ВК.КЦ.ЛидсМ — КЦ — 20.02.2026 00:19
...
$hookName = 'distant_yad_vk_kts_lidsm';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Дистант. ЯД+ВК.КЦ.ЛидсМ\n";
    $securityLog .= "Hook: distant_yad_vk_kts_lidsm\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/distant_yad_vk_kts_lidsm.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/distant_yad_vk_kts_lidsm_failed.json';
