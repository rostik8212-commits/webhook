<?php
require 'config.php';
// Брянск. КЦ. МКГ — КЦ — 11.02.2026 14:08
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. КЦ. МКГ\n";
    $securityLog .= "Hook: bryansk_kts_mkg\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_kts_mkg.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_kts_mkg_failed.json';
