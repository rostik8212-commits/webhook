<?php
require 'config.php';
// Пенза.Микс.MakeItDeal — Микс — 20.02.2026 12:45
...
$hookName = 'penza_miks_makeitdeal';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Пенза.Микс.MakeItDeal\n";
    $securityLog .= "Hook: penza_miks_makeitdeal\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/penza_miks_makeitdeal.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/penza_miks_makeitdeal_failed.json';
