<?php
require 'config.php';
// Орел. Робот.Голосовые технологии — Робот — 11.02.2026 10:22
...
$hookName = 'orel_robot_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. Робот.Голосовые технологии\n";
    $securityLog .= "Hook: orel_robot_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_robot_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_robot_golosovye_tehnologii_failed.json';
