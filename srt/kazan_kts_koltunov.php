<?php
require 'config.php';
// Казань. КЦ Колтунов — КЦ — 20.02.2026 13:45
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Казань. КЦ Колтунов\n";
    $securityLog .= "Hook: kazan_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kazan_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kazan_kts_koltunov_failed.json';
