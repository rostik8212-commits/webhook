<?php
require 'config.php';
// Орёл. Базы. Свой робот — Робот+базы — 11.02.2026 16:03
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орёл. Базы. Свой робот\n";
    $securityLog .= "Hook: orel_bazy_svoy_robot\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_bazy_svoy_robot.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_bazy_svoy_robot_failed.json';
