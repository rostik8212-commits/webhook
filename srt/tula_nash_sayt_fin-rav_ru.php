<?php
require 'config.php';
// Тула. Наш сайт. Fin-rav.ru — Wordpress — 26.02.2026 19:32
...
$hookName = 'tula_nash_sayt_fin-rav_ru';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. Наш сайт. Fin-rav.ru\n";
    $securityLog .= "Hook: tula_nash_sayt_fin-rav_ru\n";
...
if (isset($_REQUEST['test']) || (isset($_REQUEST['action']) && $_REQUEST['action'] === 'test')) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_nash_sayt_fin-rav_ru.log', date('d.m.Y H:i:s') . " " . $logMsg, FILE_APPEND);
    header('Content-Type: application/json; charset=utf-8');
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_nash_sayt_fin-rav_ru.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_nash_sayt_fin-rav_ru_failed.json';
