<?php
require 'config.php';
// Калуга.Лендинг fin-rav.ru — Wordpress — 26.02.2026 11:56
...
$hookName = 'kaluga_lending_fin-rav_ru';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.Лендинг fin-rav.ru\n";
    $securityLog .= "Hook: kaluga_lending_fin-rav_ru\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_lending_fin-rav_ru.log', $logEntry, FILE_APPEND);
...
// SOURCE_ID: базовый = FACE_TRACKER
$finalSourceId = 'FACE_TRACKER';
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_lending_fin-rav_ru_failed.json';
