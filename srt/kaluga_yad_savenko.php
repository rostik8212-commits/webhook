<?php
require 'config.php';
// Калуга.ЯД Савенко — Директ — 12.02.2026 18:17
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.ЯД Савенко\n";
    $securityLog .= "Hook: kaluga_yad_savenko\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_savenko.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_savenko_failed.json';
