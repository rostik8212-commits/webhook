<?php
require 'config.php';
// Брянск. ЯД+Робот. Make it Deal — ЯД+Робот — 11.02.2026 10:22
...
$hookName = 'bryansk_yad_robot_make_it_deal';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. ЯД+Робот. Make it Deal\n";
    $securityLog .= "Hook: bryansk_yad_robot_make_it_deal\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_yad_robot_make_it_deal.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_yad_robot_make_it_deal_failed.json';
