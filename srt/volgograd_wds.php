<?php
require 'config.php';
// Волгоград.WDS — Flexbe — 26.02.2026 11:20
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Волгоград.WDS\n";
    $securityLog .= "Hook: volgograd_wds\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/volgograd_wds.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/volgograd_wds_failed.json';
