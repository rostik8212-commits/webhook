<?php
require 'config.php';
// Волгоград. ЯД. Данилов — Tilda — 26.02.2026 11:08
...
$hookName = 'volgograd_yad_danilov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Волгоград. ЯД. Данилов\n";
    $securityLog .= "Hook: volgograd_yad_danilov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/volgograd_yad_danilov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/volgograd_yad_danilov_failed.json';
