<?php
require 'config.php';
// Владимир. КЦ Колтунов — КЦ — 20.02.2026 13:48
...
$hookName = 'vladimir_kts_koltunov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Владимир. КЦ Колтунов\n";
    $securityLog .= "Hook: vladimir_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/vladimir_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/vladimir_kts_koltunov_failed.json';
