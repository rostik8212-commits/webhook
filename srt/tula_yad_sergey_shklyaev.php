<?php
require 'config.php';
// Тула. ЯД. Сергей Шкляев — Creatium — 16.02.2026 11:03
...
$hookName = 'tula_yad_sergey_shklyaev';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. ЯД. Сергей Шкляев\n";
    $securityLog .= "Hook: tula_yad_sergey_shklyaev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_sergey_shklyaev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_sergey_shklyaev_failed.json';
