<?php
require 'config.php';
// Орёл. КЦ. МКГ — КЦ — 11.02.2026 14:10
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орёл. КЦ. МКГ\n";
    $securityLog .= "Hook: orel_kts_mkg\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_kts_mkg.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_kts_mkg_failed.json';
