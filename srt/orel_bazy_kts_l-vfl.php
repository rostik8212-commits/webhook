<?php
require 'config.php';
// Орел. Базы+КЦ.L-ВFL — Базы + КЦ — 23.02.2026 13:23
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. Базы+КЦ.L-ВFL\n";
    $securityLog .= "Hook: orel_bazy_kts_l-vfl\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_bazy_kts_l-vfl.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_bazy_kts_l-vfl_failed.json';
