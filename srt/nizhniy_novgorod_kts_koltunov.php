<?php
require 'config.php';
// Нижний Новгород. КЦ. Колтунов — КЦ — 20.02.2026 13:46
...
$hookName = 'nizhniy_novgorod_kts_koltunov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Нижний Новгород. КЦ. Колтунов\n";
    $securityLog .= "Hook: nizhniy_novgorod_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/nizhniy_novgorod_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/nizhniy_novgorod_kts_koltunov_failed.json';
