<?php
require 'config.php';
// Нижний Новгород. ЯД+робот.Make it Deal — ЯД+Робот — 23.02.2026 13:28
...
$hookName = 'nizhniy_novgorod_yad_robot_make_it_deal';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Нижний Новгород. ЯД+робот.Make it Deal\n";
    $securityLog .= "Hook: nizhniy_novgorod_yad_robot_make_it_deal\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/nizhniy_novgorod_yad_robot_make_it_deal.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/nizhniy_novgorod_yad_robot_make_it_deal_failed.json';
