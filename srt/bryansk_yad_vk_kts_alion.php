<?php
require 'config.php';
// Брянск. ЯД, ВК + КЦ Алион — ЯД+ВК+КЦ — 19.02.2026 23:55
...
$hookName = 'bryansk_yad_vk_kts_alion';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. ЯД, ВК + КЦ Алион\n";
    $securityLog .= "Hook: bryansk_yad_vk_kts_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_yad_vk_kts_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_yad_vk_kts_alion_failed.json';
