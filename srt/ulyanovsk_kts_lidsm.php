<?php
require 'config.php';
// Ульяновск.КЦ.ЛидсМ — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ульяновск.КЦ.ЛидсМ\n";
    $securityLog .= "Hook: ulyanovsk_kts_lidsm\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ulyanovsk_kts_lidsm.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ulyanovsk_kts_lidsm_failed.json';
