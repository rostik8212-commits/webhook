<?php
require 'config.php';
// Иваново. КЦ Плотников — КЦ — 20.02.2026 00:29
...
$hookName = 'ivanovo_kts_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Иваново. КЦ Плотников\n";
    $securityLog .= "Hook: ivanovo_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ivanovo_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ivanovo_kts_plotnikov_failed.json';
