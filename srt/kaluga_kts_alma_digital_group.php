<?php
require 'config.php';
// Калуга. КЦ. Alma Digital Group — КЦ — 24.02.2026 12:22
...
$hookName = 'kaluga_kts_alma_digital_group';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. КЦ. Alma Digital Group\n";
    $securityLog .= "Hook: kaluga_kts_alma_digital_group\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_alma_digital_group.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_alma_digital_group_failed.json';
