<?php
require 'config.php';
// Владимир. КЦ INDI GROUP 2 — КЦ — 18.02.2026 12:28
...
$hookName = 'vladimir_kts_indi_group_2';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Владимир. КЦ INDI GROUP 2\n";
    $securityLog .= "Hook: vladimir_kts_indi_group_2\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/vladimir_kts_indi_group_2.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/vladimir_kts_indi_group_2_failed.json';
