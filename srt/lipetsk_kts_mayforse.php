<?php
require 'config.php';
// Липецк. КЦ. Майфорсе — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. КЦ. Майфорсе\n";
    $securityLog .= "Hook: lipetsk_kts_mayforse\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_kts_mayforse.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_kts_mayforse_failed.json';
