<?php
require 'config.php';
// Яндекс Бизнес. Михайлов — Tilda — 11.02.2026 10:22
...
$hookName = 'yandeks_biznes_mihaylov';
...
// Маппинг регион → SOURCE_ID (включён)
$sourceByRegionEnabled = true;
$sourceByRegion = [
    'Саранская область' => '700',
    'Пензенская область' => '701',
    'Ростовская область' => '702',
    'Республика Мордовия' => '700',
    'Ульяновская область' => '1078',
    'Ульяновск' => '1078',
    'Волгоград' => '1079',
    'Волгоградская область' => '1079',
];
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Яндекс Бизнес. Михайлов\n";
    $securityLog .= "Hook: yandeks_biznes_mihaylov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yandeks_biznes_mihaylov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yandeks_biznes_mihaylov_failed.json';
