<?php
require 'config.php';
// Владимир. КЦ Алион — КЦ — 19.02.2026 23:58
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Владимир. КЦ Алион\n";
    $securityLog .= "Hook: vladimir_kts_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/vladimir_kts_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/vladimir_kts_alion_failed.json';
