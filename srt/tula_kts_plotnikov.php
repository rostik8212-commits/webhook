<?php
require 'config.php';
// Тула. КЦ Плотников — КЦ — 20.02.2026 00:38
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. КЦ Плотников\n";
    $securityLog .= "Hook: tula_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_kts_plotnikov_failed.json';
