<?php
require 'config.php';
// Общий.ЯД.Данилов — Директ — 26.02.2026 14:35
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Общий.ЯД.Данилов\n";
    $securityLog .= "Hook: obschiy_yad_danilov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/obschiy_yad_danilov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/obschiy_yad_danilov_failed.json';
