<?php
require 'config.php';
// Орел. КЦ. Голосовые технологии — КЦ — 11.02.2026 10:22
...
$hookName = 'orel_kts_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. КЦ. Голосовые технологии\n";
    $securityLog .= "Hook: orel_kts_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_kts_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_kts_golosovye_tehnologii_failed.json';
