<?php
require 'config.php';
// Липецк. КЦ. Маркетикс — КЦ — 20.02.2026 17:18
...
$hookName = 'lipetsk_kts_marketiks';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. КЦ. Маркетикс\n";
    $securityLog .= "Hook: lipetsk_kts_marketiks\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_kts_marketiks.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_kts_marketiks_failed.json';
