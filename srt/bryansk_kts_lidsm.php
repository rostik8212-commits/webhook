<?php
require 'config.php';
// Брянск. КЦ ЛидсМ — КЦ — 20.02.2026 00:15
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. КЦ ЛидсМ\n";
    $securityLog .= "Hook: bryansk_kts_lidsm\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_kts_lidsm.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_kts_lidsm_failed.json';
