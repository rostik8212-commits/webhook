<?php
require 'config.php';
// Калуга.ЯД.Бизнес — Tilda — 26.02.2026 12:31
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.ЯД.Бизнес\n";
    $securityLog .= "Hook: kaluga_yad_biznes\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_biznes.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_biznes_failed.json';
