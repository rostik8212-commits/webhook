<?php
require 'config.php';
// Брянск.Робот. Плотников — Робот — 11.02.2026 10:22
...
$hookName = 'bryansk_robot_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск.Робот. Плотников\n";
    $securityLog .= "Hook: bryansk_robot_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_robot_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_robot_plotnikov_failed.json';
