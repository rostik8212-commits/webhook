<?php
require 'config.php';
// Ярославль. ЯД. бизнес — Tilda — 26.02.2026 10:18
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. ЯД. бизнес\n";
    $securityLog .= "Hook: yaroslavl_yad_biznes\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_yad_biznes.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_yad_biznes_failed.json';
