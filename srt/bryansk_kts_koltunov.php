<?php
require 'config.php';
// Брянск. КЦ Колтунов — КЦ — 20.02.2026 13:49
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. КЦ Колтунов\n";
    $securityLog .= "Hook: bryansk_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_kts_koltunov_failed.json';
