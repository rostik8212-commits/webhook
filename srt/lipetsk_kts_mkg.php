<?php
require 'config.php';
// Липецк. КЦ. МКГ — КЦ — 11.02.2026 14:11
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Липецк. КЦ. МКГ\n";
    $securityLog .= "Hook: lipetsk_kts_mkg\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/lipetsk_kts_mkg.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/lipetsk_kts_mkg_failed.json';
