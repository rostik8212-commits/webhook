<?php
require 'config.php';
// Пенза.ВК.Милена — Tilda — 24.02.2026 23:24
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Пенза.ВК.Милена\n";
    $securityLog .= "Hook: penza_vk_milena\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/penza_vk_milena.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/penza_vk_milena_failed.json';
