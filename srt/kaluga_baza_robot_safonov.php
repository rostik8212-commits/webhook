<?php
require 'config.php';
// Калуга. База. Робот. Сафонов — Zvonok.com — 11.02.2026 10:22
...
$hookName = 'kaluga_baza_robot_safonov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. База. Робот. Сафонов\n";
    $securityLog .= "Hook: kaluga_baza_robot_safonov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_baza_robot_safonov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_baza_robot_safonov_failed.json';
