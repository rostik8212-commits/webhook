<?php
require 'config.php';
// Ярославль. КЦ Голосовые технологии — КЦ — 24.02.2026 12:42
...
$hookName = 'yaroslavl_kts_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. КЦ Голосовые технологии\n";
    $securityLog .= "Hook: yaroslavl_kts_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_kts_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_kts_golosovye_tehnologii_failed.json';
