<?php
require 'config.php';
// Калуга. ВК таргет. Комов — ВК — 25.02.2026 14:11
...
$hookName = 'kaluga_vk_target_komov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. ВК таргет. Комов\n";
    $securityLog .= "Hook: kaluga_vk_target_komov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_vk_target_komov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_vk_target_komov_failed.json';
