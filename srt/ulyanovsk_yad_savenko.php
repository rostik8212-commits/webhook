<?php
require 'config.php';
// Ульяновск. ЯД. Савенко — Директ — 11.02.2026 10:22
...
$hookName = 'ulyanovsk_yad_savenko';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ульяновск. ЯД. Савенко\n";
    $securityLog .= "Hook: ulyanovsk_yad_savenko\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ulyanovsk_yad_savenko.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ulyanovsk_yad_savenko_failed.json';
