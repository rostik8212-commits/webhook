<?php
require 'config.php';
// Ульяновск. КЦ.Голосовые Технологии — КЦ — 24.02.2026 14:59
...
$hookName = 'ulyanovsk_kts_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ульяновск. КЦ.Голосовые Технологии\n";
    $securityLog .= "Hook: ulyanovsk_kts_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ulyanovsk_kts_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ulyanovsk_kts_golosovye_tehnologii_failed.json';
