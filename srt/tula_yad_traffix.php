<?php
require 'config.php';
// Тула.ЯД.TRAFFIX — Директ — 25.02.2026 16:39
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула.ЯД.TRAFFIX\n";
    $securityLog .= "Hook: tula_yad_traffix\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_traffix.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_traffix_failed.json';
