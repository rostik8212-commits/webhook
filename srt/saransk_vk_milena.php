<?php
require 'config.php';
// Саранск.ВК.Милена — Tilda — 24.02.2026 23:25
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Саранск.ВК.Милена\n";
    $securityLog .= "Hook: saransk_vk_milena\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/saransk_vk_milena.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/saransk_vk_milena_failed.json';
