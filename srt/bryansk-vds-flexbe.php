<?php
require 'config.php';
// Брянск-ВДС-flexbe — Flexbe — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск-ВДС-flexbe\n";
    $securityLog .= "Hook: bryansk-vds-flexbe\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk-vds-flexbe.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk-vds-flexbe_failed.json';
