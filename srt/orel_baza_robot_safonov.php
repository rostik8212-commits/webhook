<?php
require 'config.php';
// Орел. База. Робот. Сафонов — Zvonok.com — 11.02.2026 10:22
...
$hookName = 'orel_baza_robot_safonov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. База. Робот. Сафонов\n";
    $securityLog .= "Hook: orel_baza_robot_safonov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_baza_robot_safonov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_baza_robot_safonov_failed.json';
