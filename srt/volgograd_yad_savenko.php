<?php
require 'config.php';
// Волгоград. ЯД Савенко — Директ — 11.02.2026 10:22
...
$hookName = 'volgograd_yad_savenko';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Волгоград. ЯД Савенко\n";
    $securityLog .= "Hook: volgograd_yad_savenko\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/volgograd_yad_savenko.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/volgograd_yad_savenko_failed.json';
