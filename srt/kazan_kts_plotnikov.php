<?php
require 'config.php';
// Казань. КЦ Плотников — КЦ — 20.02.2026 00:36
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Казань. КЦ Плотников\n";
    $securityLog .= "Hook: kazan_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kazan_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kazan_kts_plotnikov_failed.json';
