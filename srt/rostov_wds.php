<?php
require 'config.php';
// Ростов.WDS — Flexbe — 26.02.2026 11:27
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ростов.WDS\n";
    $securityLog .= "Hook: rostov_wds\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/rostov_wds.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/rostov_wds_failed.json';
