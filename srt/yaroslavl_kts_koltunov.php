<?php
require 'config.php';
// Ярославль. КЦ Колтунов — КЦ — 20.02.2026 13:52
...
$hookName = 'yaroslavl_kts_koltunov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. КЦ Колтунов\n";
    $securityLog .= "Hook: yaroslavl_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_kts_koltunov_failed.json';
