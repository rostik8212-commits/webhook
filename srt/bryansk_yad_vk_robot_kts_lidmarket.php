<?php
require 'config.php';
// Брянск. ЯД.ВК.Робот+КЦ.Лидмаркет — ЯД+ВК — 11.02.2026 15:03
...
$hookName = 'bryansk_yad_vk_robot_kts_lidmarket';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. ЯД.ВК.Робот+КЦ.Лидмаркет\n";
    $securityLog .= "Hook: bryansk_yad_vk_robot_kts_lidmarket\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_yad_vk_robot_kts_lidmarket.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_yad_vk_robot_kts_lidmarket_failed.json';
