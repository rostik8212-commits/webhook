<?php
require 'config.php';
// Иваново. КЦ L- BFL — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Иваново. КЦ L- BFL\n";
    $securityLog .= "Hook: ivanovo_kts_l-_bfl\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ivanovo_kts_l-_bfl.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ivanovo_kts_l-_bfl_failed.json';
