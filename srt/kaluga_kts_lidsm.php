<?php
require 'config.php';
// Калуга. КЦ ЛидсМ — КЦ — 20.02.2026 00:16
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. КЦ ЛидсМ\n";
    $securityLog .= "Hook: kaluga_kts_lidsm\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_lidsm.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_lidsm_failed.json';
