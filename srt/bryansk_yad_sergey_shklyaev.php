<?php
require 'config.php';
// Брянск. ЯД. Сергей Шкляев — Creatium — 11.02.2026 10:22
...
$hookName = 'bryansk_yad_sergey_shklyaev';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. ЯД. Сергей Шкляев\n";
    $securityLog .= "Hook: bryansk_yad_sergey_shklyaev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_yad_sergey_shklyaev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_yad_sergey_shklyaev_failed.json';
