<?php
require 'config.php';
// Брянск. ВК. NS Marketing (ИП Сергеев) — ВК — 11.02.2026 10:22
...
$hookName = 'bryansk_vk_ns_marketing_ip_sergeev';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. ВК. NS Marketing (ИП Сергеев)\n";
    $securityLog .= "Hook: bryansk_vk_ns_marketing_ip_sergeev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_vk_ns_marketing_ip_sergeev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_vk_ns_marketing_ip_sergeev_failed.json';
