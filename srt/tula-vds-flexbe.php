<?php
require 'config.php';
// Тула-ВДС-flexbe — Flexbe — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула-ВДС-flexbe\n";
    $securityLog .= "Hook: tula-vds-flexbe\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula-vds-flexbe.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula-vds-flexbe_failed.json';
