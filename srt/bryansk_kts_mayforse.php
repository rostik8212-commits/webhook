<?php
require 'config.php';
// Брянск. КЦ Майфорсе — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. КЦ Майфорсе\n";
    $securityLog .= "Hook: bryansk_kts_mayforse\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_kts_mayforse.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_kts_mayforse_failed.json';
