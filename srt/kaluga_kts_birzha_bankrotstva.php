<?php
require 'config.php';
// Калуга. КЦ. Биржа банкротства — КЦ — 16.02.2026 15:35
...
$hookName = 'kaluga_kts_birzha_bankrotstva';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. КЦ. Биржа банкротства\n";
    $securityLog .= "Hook: kaluga_kts_birzha_bankrotstva\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_birzha_bankrotstva.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_birzha_bankrotstva_failed.json';
