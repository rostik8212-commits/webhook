<?php
require 'config.php';
// Ростов.ЯД Данилов — Tilda — 26.02.2026 14:11
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ростов.ЯД Данилов\n";
    $securityLog .= "Hook: rostov_yad_danilov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/rostov_yad_danilov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/rostov_yad_danilov_failed.json';
