<?php
require 'config.php';
// Калуга. КЦ Маркетикс — КЦ — 20.02.2026 18:32
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. КЦ Маркетикс\n";
    $securityLog .= "Hook: kaluga_kts_marketiks\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_kts_marketiks.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_kts_marketiks_failed.json';
