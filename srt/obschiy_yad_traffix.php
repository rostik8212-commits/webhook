<?php
require 'config.php';
// Общий. ЯД.TRAFFIX — Директ — 25.02.2026 17:05
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Общий. ЯД.TRAFFIX\n";
    $securityLog .= "Hook: obschiy_yad_traffix\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/obschiy_yad_traffix.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/obschiy_yad_traffix_failed.json';
