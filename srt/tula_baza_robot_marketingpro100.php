<?php
require 'config.php';
// Тула. База. Робот. МаркетингПро100 — Робот+базы — 20.02.2026 11:56
...
$hookName = 'tula_baza_robot_marketingpro100';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. База. Робот. МаркетингПро100\n";
    $securityLog .= "Hook: tula_baza_robot_marketingpro100\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_baza_robot_marketingpro100.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_baza_robot_marketingpro100_failed.json';
