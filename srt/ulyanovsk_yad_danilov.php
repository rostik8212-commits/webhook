<?php
require 'config.php';
// Ульяновск.ЯД.Данилов — Tilda — 26.02.2026 11:09
...
$hookName = 'ulyanovsk_yad_danilov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ульяновск.ЯД.Данилов\n";
    $securityLog .= "Hook: ulyanovsk_yad_danilov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ulyanovsk_yad_danilov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ulyanovsk_yad_danilov_failed.json';
