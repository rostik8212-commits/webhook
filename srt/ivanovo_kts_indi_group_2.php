<?php
require 'config.php';
// Иваново. КЦ INDI GROUP 2 — КЦ — 18.02.2026 12:27
...
$hookName = 'ivanovo_kts_indi_group_2';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Иваново. КЦ INDI GROUP 2\n";
    $securityLog .= "Hook: ivanovo_kts_indi_group_2\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ivanovo_kts_indi_group_2.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ivanovo_kts_indi_group_2_failed.json';
