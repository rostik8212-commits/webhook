<?php
require 'config.php';
// Тула. КЦ Майфорсе — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. КЦ Майфорсе\n";
    $securityLog .= "Hook: tula_kts_mayforse\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_kts_mayforse.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_kts_mayforse_failed.json';
