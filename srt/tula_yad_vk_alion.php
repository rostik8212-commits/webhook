<?php
require 'config.php';
// Тула. ЯД+ВК. Алион — ЯД+ВК — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. ЯД+ВК. Алион\n";
    $securityLog .= "Hook: tula_yad_vk_alion\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_vk_alion.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_vk_alion_failed.json';
