<?php
require 'config.php';
// Ярославль. КЦ Плотников — КЦ — 20.02.2026 00:37
...
$hookName = 'yaroslavl_kts_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. КЦ Плотников\n";
    $securityLog .= "Hook: yaroslavl_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_kts_plotnikov_failed.json';
