<?php
require 'config.php';
// Калуга.Робот. Голосовые технологии — Робот — 11.02.2026 10:22
...
$hookName = 'kaluga_robot_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга.Робот. Голосовые технологии\n";
    $securityLog .= "Hook: kaluga_robot_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_robot_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_robot_golosovye_tehnologii_failed.json';
