<?php
require 'config.php';
// Владимир.Яд.Бизнес — Tilda — 26.02.2026 10:09
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Владимир.Яд.Бизнес\n";
    $securityLog .= "Hook: vladimir_yad_biznes\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/vladimir_yad_biznes.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/vladimir_yad_biznes_failed.json';
