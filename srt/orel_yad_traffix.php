<?php
require 'config.php';
// Орёл.ЯД.TRAFFIX — Директ — 25.02.2026 17:04
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орёл.ЯД.TRAFFIX\n";
    $securityLog .= "Hook: orel_yad_traffix\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_yad_traffix.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_yad_traffix_failed.json';
