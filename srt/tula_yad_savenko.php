<?php
require 'config.php';
// Тула.ЯД Савенко — Директ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула.ЯД Савенко\n";
    $securityLog .= "Hook: tula_yad_savenko\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_yad_savenko.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_yad_savenko_failed.json';
