<?php
require 'config.php';
// Иваново. КЦ Голосовые технологии — КЦ — 23.02.2026 12:57
...
$hookName = 'ivanovo_kts_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Иваново. КЦ Голосовые технологии\n";
    $securityLog .= "Hook: ivanovo_kts_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ivanovo_kts_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ivanovo_kts_golosovye_tehnologii_failed.json';
