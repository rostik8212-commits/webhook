<?php
require 'config.php';
// Ульяновск. WDS — Flexbe — 26.02.2026 11:17
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ульяновск. WDS\n";
    $securityLog .= "Hook: ulyanovsk_wds\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/ulyanovsk_wds.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/ulyanovsk_wds_failed.json';
