<?php
require 'config.php';
// Саранск.Микс.MakeItDeal — Микс — 11.02.2026 10:22
...
$hookName = 'saransk_miks_makeitdeal';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Саранск.Микс.MakeItDeal\n";
    $securityLog .= "Hook: saransk_miks_makeitdeal\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/saransk_miks_makeitdeal.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/saransk_miks_makeitdeal_failed.json';
