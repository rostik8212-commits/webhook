<?php
require 'config.php';
// Калуга. Маркетинг. Новый Лендинг — Tilda — 26.02.2026 15:48
...
$hookName = 'kaluga_marketing_novyy_lending';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. Маркетинг. Новый Лендинг\n";
    $securityLog .= "Hook: kaluga_marketing_novyy_lending\n";
...
if (isset($_REQUEST['test']) || (isset($_REQUEST['action']) && $_REQUEST['action'] === 'test')) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_marketing_novyy_lending.log', date('d.m.Y H:i:s') . " " . $logMsg, FILE_APPEND);
    header('Content-Type: application/json; charset=utf-8');
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_marketing_novyy_lending.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_marketing_novyy_lending_failed.json';
