<?php
require 'config.php';
// Калуга. ЯД+Робот. Make it Deal — ЯД+Робот — 11.02.2026 10:22
...
$hookName = 'kaluga_yad_robot_make_it_deal';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. ЯД+Робот. Make it Deal\n";
    $securityLog .= "Hook: kaluga_yad_robot_make_it_deal\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_robot_make_it_deal.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_robot_make_it_deal_failed.json';
