<?php
require 'config.php';
// Орел. ЯД. Сергей Шкляев — Creatium — 11.02.2026 10:22
...
$hookName = 'orel_yad_sergey_shklyaev';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. ЯД. Сергей Шкляев\n";
    $securityLog .= "Hook: orel_yad_sergey_shklyaev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_yad_sergey_shklyaev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_yad_sergey_shklyaev_failed.json';
