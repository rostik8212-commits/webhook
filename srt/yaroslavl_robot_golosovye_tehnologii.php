<?php
require 'config.php';
// Ярославль. робот Голосовые технологии — Робот — 24.02.2026 12:40
...
$hookName = 'yaroslavl_robot_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ярославль. робот Голосовые технологии\n";
    $securityLog .= "Hook: yaroslavl_robot_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/yaroslavl_robot_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/yaroslavl_robot_golosovye_tehnologii_failed.json';
