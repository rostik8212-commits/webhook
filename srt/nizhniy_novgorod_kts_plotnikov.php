<?php
require 'config.php';
// Нижний Новгород. КЦ Плотников — КЦ — 20.02.2026 00:41
...
$hookName = 'nizhniy_novgorod_kts_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Нижний Новгород. КЦ Плотников\n";
    $securityLog .= "Hook: nizhniy_novgorod_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/nizhniy_novgorod_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/nizhniy_novgorod_kts_plotnikov_failed.json';
