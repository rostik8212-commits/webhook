<?php
require 'config.php';
// Тула. Робот.Голосовые технологии — Робот — 11.02.2026 10:22
...
$hookName = 'tula_robot_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Тула. Робот.Голосовые технологии\n";
    $securityLog .= "Hook: tula_robot_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tula_robot_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tula_robot_golosovye_tehnologii_failed.json';
