<?php
require 'config.php';
// Орел. ЯД. ФиксГрупп — Директ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. ЯД. ФиксГрупп\n";
    $securityLog .= "Hook: orel_yad_fiksgrupp\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_yad_fiksgrupp.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_yad_fiksgrupp_failed.json';
