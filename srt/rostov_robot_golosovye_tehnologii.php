<?php
require 'config.php';
// Ростов.Робот.Голосовые Технологии — Робот — 18.02.2026 12:32
...
$hookName = 'rostov_robot_golosovye_tehnologii';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ростов.Робот.Голосовые Технологии\n";
    $securityLog .= "Hook: rostov_robot_golosovye_tehnologii\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/rostov_robot_golosovye_tehnologii.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/rostov_robot_golosovye_tehnologii_failed.json';
