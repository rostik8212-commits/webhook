<?php
require 'config.php';
// Калуга. ЯД. TRAFFIX — Директ — 25.02.2026 17:02
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. ЯД. TRAFFIX\n";
    $securityLog .= "Hook: kaluga_yad_traffix\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_traffix.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_traffix_failed.json';
