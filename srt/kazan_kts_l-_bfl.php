<?php
require 'config.php';
// Казань. КЦ L- BFL — КЦ — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Казань. КЦ L- BFL\n";
    $securityLog .= "Hook: kazan_kts_l-_bfl\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kazan_kts_l-_bfl.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kazan_kts_l-_bfl_failed.json';
