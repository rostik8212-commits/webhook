<?php
require 'config.php';
// Калуга. ЯД. Сергей Шкляев — Creatium — 16.02.2026 11:02
...
$hookName = 'kaluga_yad_sergey_shklyaev';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Калуга. ЯД. Сергей Шкляев\n";
    $securityLog .= "Hook: kaluga_yad_sergey_shklyaev\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/kaluga_yad_sergey_shklyaev.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/kaluga_yad_sergey_shklyaev_failed.json';
