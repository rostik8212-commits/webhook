<?php
require 'config.php';
// Орел. КЦ.Колтунов — КЦ — 20.02.2026 13:44
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Орел. КЦ.Колтунов\n";
    $securityLog .= "Hook: orel_kts_koltunov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/orel_kts_koltunov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/orel_kts_koltunov_failed.json';
