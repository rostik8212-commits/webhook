<?php
require 'config.php';
// Ростов. ВК. Милена — Tilda — 16.02.2026 17:11
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Ростов. ВК. Милена\n";
    $securityLog .= "Hook: rostov_vk_milena\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/rostov_vk_milena.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/rostov_vk_milena_failed.json';
