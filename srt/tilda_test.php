<?php
require 'config.php';
// тильда тест — Tilda — 11.02.2026 10:22
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: тильда тест\n";
    $securityLog .= "Hook: tilda_test\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/tilda_test.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/tilda_test_failed.json';
