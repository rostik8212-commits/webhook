<?php
require 'config.php';
// Пенза.НовыйЯД.Данилов — Tilda — 26.02.2026 12:42
...
$hookName = 'penza_novyyyad_danilov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Пенза.НовыйЯД.Данилов\n";
    $securityLog .= "Hook: penza_novyyyad_danilov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/penza_novyyyad_danilov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/penza_novyyyad_danilov_failed.json';
