<?php
require 'config.php';
// Саранск. ВДС — Flexbe — 26.02.2026 11:26
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Саранск. ВДС\n";
    $securityLog .= "Hook: saransk_vds\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/saransk_vds.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/saransk_vds_failed.json';
