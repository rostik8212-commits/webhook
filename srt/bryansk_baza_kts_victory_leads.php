<?php
require 'config.php';
// Брянск. База. КЦ. Victory Leads — КЦ — 11.02.2026 10:22
...
$hookName = 'bryansk_baza_kts_victory_leads';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск. База. КЦ. Victory Leads\n";
    $securityLog .= "Hook: bryansk_baza_kts_victory_leads\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_baza_kts_victory_leads.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_baza_kts_victory_leads_failed.json';
