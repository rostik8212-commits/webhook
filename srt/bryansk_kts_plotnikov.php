<?php
require 'config.php';
// Брянск.КЦ.Плотников — КЦ — 20.02.2026 00:27
...
$hookName = 'bryansk_kts_plotnikov';
...
if ($detectedMethod) {
    ...
    $securityLog .= "Интеграция: Брянск.КЦ.Плотников\n";
    $securityLog .= "Hook: bryansk_kts_plotnikov\n";
...
if (!$phoneValid) {
    ...
    file_put_contents(__DIR__ . '/../logs/bryansk_kts_plotnikov.log', $logEntry, FILE_APPEND);
...
if ($deliveryFailed) {
    ...
    $failedFile = __DIR__ . '/../logs/bryansk_kts_plotnikov_failed.json';
